...
class Prota:
    def __init__(self, x, y):
        self.x = x
        self.y = y
        self.Cargar = pygame.image.load("sprites/Beta_caballero.png")
        self.altura_deseada = 200  # Aumentado de 100 a 150
        self.ajustar_imagen()
        self.vida = 100
        self.daño = 20
        self.critico = 30
    ...
    #tal como dice el nombre modifica la vida del prota
