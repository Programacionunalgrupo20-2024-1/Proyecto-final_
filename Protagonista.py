...
class Prota:
    def __init__(self, x, y):
        ...
        self.daño = 20
        self.critico = 30
        self.tiempo_animacion = 125  # Controlar la velocidad de animación (125ms entre frames)
    ...
    def actualizar_animacion(self):
        # Verificar si ha pasado suficiente tiempo para cambiar de frame
    ...
    def dibujar_barra_vida(self, screen, font):
        ...
        screen.blit(texto_negro, (self.x, self.y - 41))  # Borde negro
        screen.blit(texto_blanco, (self.x + 1, self.y - 40))  # Texto blanco
